...
public class AssociateProfileFollowUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_associate_profile_follow_up);
    ...
    private void saveData() {
        ...
        Associate associate = new Associate(name,phone,pincode,city
                ,user.getEmail().toString(),"Associate",new ArrayList<>(),new ArrayList<>());
        documentReference.set(associate);
        //add name of user
